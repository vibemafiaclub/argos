...
export function SessionTimelineChart({
  ...
  // Optimization: Memoize the tool calls and Recharts data arrays to prevent expensive unnecessary re-renders.
  // Impact: Reduces re-renders and improves responsiveness of the dashboard by avoiding filtering and mapping over usage data repeatedly.
